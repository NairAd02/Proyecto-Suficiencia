...
public class AtributosMismoName extends JFrame {
	...
	private JLabel lblExisteUnAtributo;


	/**
	 * Create the frame.
	 */
	public AtributosMismoName(JFrame p) {
		pe = p;
		...
		label_1 = new JLabel("");
		label_1.setIcon(new ImageIcon(AtributosMismoName.class.getResource("/images/warning.png")));
		label_1.setBounds(10, 21, 50, 50);
		contentPane.add(label_1);
		
		lblExisteUnAtributo = new JLabel("Ya existe un atributo con ese nombre.");
		lblExisteUnAtributo.setFont(new Font("Dialog", Font.BOLD, 17));
		lblExisteUnAtributo.setBounds(58, 26, 318, 41);
		contentPane.add(lblExisteUnAtributo);
	}
}
